  ...
  return (
    <div className="w-full min-h-screen px-3 bg-black flex direction-column">
      <div className="max-w-4xl  m-auto">
        <h1 className="text-teal-700 text-center text-7xl w-fit m-auto font-extrabold">
          <p className="text-xl text-start">Hello,</p> I'm Waqas,
        </h1>
        <h2 className="text-gray-500 text-center w-fit my-5 mx-auto text-5xl font-bold flex justify-center ">
          <Typewriter
            options={{
        ...
        <p className="text-gray-500 my-9 w-[500px] mx-auto text-center">
